    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> CartUpsert(CartDto cartDto)
        {
            try
            {
                ...
                {
                    // if there is no cart info about the user in the CartHeader table, create one - CartHeader and CartDetails
                ...
                else
                {
                    ...
                    // check if the user has this product in his cart already
                    ...
                    {
                        // create CartDetails for that user's product
                    ...
                    {
                        // update the count value of the CartDetails for that user's product
